class Editor {
    ...
    setupUI() {
        ...
        document.getElementById('propSize').addEventListener('input', (e) => {
            ...
            this.selectedObjects.forEach(obj => {
                if (obj.radius !== undefined) obj.radius = val;
        ...
        document.getElementById('propRotation').addEventListener('input', (e) => updateProp('angle', e.target.value));
