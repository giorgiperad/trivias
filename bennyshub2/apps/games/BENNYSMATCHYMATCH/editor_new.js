...
function handleAudioShortcuts(e) {
    if (document.getElementById('audio-editor-modal').style.display === 'none') return;
...
async function searchSymbols() {
    ...
    try {
        ...
        console.error(e);
        container.innerHTML = '<div style="text-align:center; padding:20px; color:red;">Error searching symbols. Please check your internet connection.</div>';
    }
}
...
async function searchSounds() {
    ...
    container.innerHTML = '<div style="text-align:center; padding:20px;">Searching FreeSound...</div>';
    ...
    try {
        ...
        if (!data.results || data.results.length === 0) {
            container.innerHTML = '<div style="text-align:center; padding:20px;">No sounds found.</div>';
            return;
        }
        ...
        container.innerHTML = '<div style="color:red; text-align:center;">Search failed.</div>';
        console.error(e);
    }
}
